...
public class SpecGroupServiceImpl extends BaseApiService implements SpecGroupService {
    ...
    @Override
    @Transactional
    public Result<JSONUtil> addSpecParam(SpecParamDTO specParamDTO) {
    ...
    @Override
    @Transactional
    public Result<JSONUtil> updateSpecParam(SpecParamDTO specParamDTO) {
    ...
    @Override
    @Transactional
    public Result<JSONUtil> deleteSpecParam(Integer id) {
