...
![](E:\淘宝项目\image\screenshot_20210311_211106.png)
...
public Result<List<BrandEntity>> getBrandByIds(String brandIds) { 
	List<Integer> brandIdsArr = Arrays.asList(brandIds.split(",")) .stream().map(idStr -> 				    								Integer.parseInt(idStr)).collect(Collectors.toList()); 
	List<BrandEntity> list = brandMapper.selectByIdList(brandIdsArr); return this.setResultSuccess(list);
}
```
...
![](E:\淘宝项目\image\screenshot_20210311_212353.png)

![](E:\淘宝项目\image\screenshot_20210311_212402.png)

![](E:\淘宝项目\image\screenshot_20210311_212415.png)
...
![](E:\淘宝项目\image\screenshot_20210311_212741.png)

### 3.3 问题

当前程序是做完了,好像也并没有什么问题 但是我可以告诉你们一个非常大的问题 用户体验 现在我们是本地开发,如果项目上线的话 当前的搜索效率有点慢,尤其是加上聚合后(我们还有一个规格没有加上呢) 所以我们拆一下方法,说白了就是拆接口,分发请求 拆请求的话会增加大家电脑的压力,大家看一下代码就可以了,不需要实现
...
public GoodsResponse search(String search, Integer page) {
	...
	List<CategoryEntity> cateResult =
        ...
        Double.valueOf(Math.ceil(Long.valueOf(hits.getTotalHits()).doubleValue() /
        10)).intValue(), brandResult, cateResult, goodsDocs);
        return goodsResponse;
}
...
![](E:\淘宝项目\image\screenshot_20210311_213833.png)
...
![](E:\淘宝项目\image\screenshot_20210311_214013.png)
...
![](E:\淘宝项目\image\screenshot_20210311_214131.png)
...
![](E:\淘宝项目\image\screenshot_20210311_214314.png)
...
![](E:\淘宝项目\image\screenshot_20210311_214519.png)
...
![](E:\淘宝项目\image\screenshot_20210311_214733.png)

![](E:\淘宝项目\image\screenshot_20210311_214742.png)
...
<!--点击改变showMore的状态
    ...
    <v-btn small flat @click="showMore = true" vshow="!showMore">
   		 更多<v-icon>arrow_drop_down</v-icon>
    </v-btn>
    <v-btn small="" flat @click="showMore = false" vshow="showMore">
...
![](E:\淘宝项目\image\screenshot_20210311_214913.png)

还有一些赋值操作

![](E:\淘宝项目\image\screenshot_20210311_214935.png)

这些其实都是过滤条件数据

 所以我们将这些数据合并成一个对象

![](E:\淘宝项目\image\screenshot_20210311_215005.png)

![](E:\淘宝项目\image\screenshot_20210311_215012.png)
...
//处理sku
    const goodsList = resp.data.data.map(goods => {
        ...
        //Object.assign --> 会将参数二(json对象{key:value})的key和
        value取出来放到参数一中
...
![](E:\淘宝项目\image\screenshot_20210311_215317.png)

![](E:\淘宝项目\image\screenshot_20210311_215323.png)

![](E:\淘宝项目\image\screenshot_20210311_215330.png)
...
![](E:\淘宝项目\image\screenshot_20210311_215555.png)

![](E:\淘宝项目\image\screenshot_20210311_215612.png)
...
![](E:\淘宝项目\image\screenshot_20210311_215707.png)

![](E:\淘宝项目\image\screenshot_20210311_215722.png)
...
![](E:\淘宝项目\image\screenshot_20210311_215812.png)
...
![](E:\淘宝项目\image\screenshot_20210311_215936.png)
...
![](E:\淘宝项目\image\screenshot_20210311_220006.png)
